    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (isset($_FILES["logo"]) && !empty($_FILES["logo"]['name'])) {
                ...
                $img_name = $this->media_storage->fileupload("logo", "./uploads/system_content/logo/");
                ...
                if ($this->input->post('id') != '') {
                    ...
                    if ($row->logo != '') {
                        $this->media_storage->filedelete($row->logo, "uploads/system_content/logo/");
                    }
                }
                $data['logo'] = "./uploads/system_content/logo/" .$img_name;

            }
            if (isset($_FILES["fav_icon"]) && !empty($_FILES["fav_icon"]['name'])) {

                $img_name = $this->media_storage->fileupload("fav_icon", "./uploads/system_content/logo/");

                if ($this->input->post('id') != '') {
                    $row = $this->frontcms_setting_model->get($this->input->post('id'));
                    if ($row->fav_icon != '') {
                        $this->media_storage->filedelete($row->fav_icon, "uploads/system_content/logo/");
                    }
                }
                $data['fav_icon'] = "./uploads/system_content/logo/" .$img_name;
            }
