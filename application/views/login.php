                                ...
                                <div class="loginbg">  
                                   <!-- <div class="form-top">
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        ?>
                                        <form action="<?php echo site_url('staff/login') ?>" method="post">
                                        ...
                                        <a href="<?php echo site_url('staff/forgotpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_your_password'); ?>?</a>
                                    </div>
                                </div>
                            </div> 
                        </div>  
