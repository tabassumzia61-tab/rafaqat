                    ...
                    <div style="width: 100%;float: left;padding: 20px 0;">
                        ...
                        <div style="width: 82%;float: left;">
                            <div style="width: 100%;float: left;">
                                <div style="width: 100%;float: left;text-align: right;color: #000;font-size: 45px;font-weight: bold;"><?php echo 'Quotations'; ?></div>   
                            </div>
                        </div>
                    </div>
                                ...
                                <table style="width: 450px; border: none;float: right;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php if(!empty($quotationsList['date']) || $quotationsList['date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($quotationsList['date'])); } ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Quotations#: '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $quotationsList['quotes_no']; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Customer ID : '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $quotationsList['customers_no']; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Expiry Date: '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php if(!empty($quotationsList['expiry_date']) || $quotationsList['expiry_date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($quotationsList['expiry_date'])); } ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($quotationsList['total'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('discount') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($quotationsList['total_discount'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('sale_tax') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($quotationsList['total_tax'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('net_amount') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($quotationsList['grand_total'],2,'.',','); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
