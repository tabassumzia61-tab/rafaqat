                ...
                <div style="width: 100%;float: left;">
                    <div style="width: 100%;float: left;padding-bottom: 15px;margin-top:15px;">
                        <div style="width: 50%;float: left;">
                            ...
                            <div style="width: 100%;float: left;"><?php echo 'Company Name: ';?> <?php echo $purchasereturnList['company']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Name: ';?> <?php echo $purchasereturnList['name'].' '.$purchasereturnList['surname']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Address: ';?> <?php echo $purchasereturnList['address']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'E-mail: ';?> <?php echo $purchasereturnList['email']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Phone: ';?> <?php echo $purchasereturnList['phone']; ?></div>
                        </div>
                                ...
                                <table style="width: 450px; border: none;float: right;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php if(!empty($purchasereturnList['date']) || $purchasereturnList['date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($purchasereturnList['date'])); } ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Bill No#: '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $purchasereturnList['purchase_no']; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Supplier ID : '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $purchasereturnList['supplier_no']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div style="width: 100%;float: left;margin-top:10px;">
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            $count = 1;  
                                            if(!empty($purchasereturnList['orderitem'])){ 
                                                foreach ($purchasereturnList['orderitem'] as $oi_key => $oi_val) { ?>
                                                    <tr>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($purchasereturnList['total'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('discount'); //. ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($purchasereturnList['total_discount'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('exclusive_of_gst'); //. ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($purchasereturnList['total'] - $purchasereturnList['total_discount'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('sale_tax'); //. ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($purchasereturnList['total_tax'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('net_amount'); //. ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($purchasereturnList['grand_total'],2,'.',','); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align:left;padding: 5px;">
                                                <?php if(!empty($purchasereturnList['note'])){ echo strip_tags($purchasereturnList['note']); } ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
