                ...
                <div class="first-warp-content">
                                ...
                                <table style="width: 450px; border: none;float: right;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php if(!empty($salereturnList['date']) || $salereturnList['date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($salereturnList['date'])); } ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Sale#: '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $salereturnList['sale_no']; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php echo 'Customer ID : '; ?></b></td>
                                            <td style="text-align: left;padding: 5px;width: 80px;"><?php echo $salereturnList['customers_no']; ?></td>
                                        </tr>
                                        <!--<tr>-->
                                        <!--    <td style="text-align: left;padding: 5px 5px 5px 30px;border: none;width: 80px;"><b><?php //echo 'Due Date: '; ?></b></td>-->
                                        <!--    <td style="text-align: left;padding: 5px;width: 80px;"><?php //if(!empty($salereturnList['due_date']) || $salereturnList['due_date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($salereturnList['due_date'])); } ?></td>-->
                                        <!--</tr>-->
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div style="width: 100%;float: left;padding-bottom: 5px;">
                        <div style="width: 50%;float: left;padding:0 0 0 15px;">
                            ...
                            <div style="width: 100%;float: left;"><?php echo 'Company Name: ';?> <?php echo $salereturnList['company']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Name: ';?> <?php echo $salereturnList['name'].' '.$salereturnList['surname']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Address: ';?> <?php echo $salereturnList['address']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'E-mail: ';?> <?php echo $salereturnList['email']; ?></div>
                            <div style="width: 100%;float: left;"><?php echo 'Phone: ';?> <?php echo $salereturnList['phone']; ?></div>
                        </div>
                    </div>
                    <div style="width: 100%;float: left;padding-bottom: 5px;">
                            ...
                            <div style="width: 100%;float: left;margin-top:10px;">
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            $count = 1;  
                                            if(!empty($salereturnList['orderitem'])){ 
                                                foreach ($salereturnList['orderitem'] as $oi_key => $oi_val) { ?>
                                                    <tr>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($salereturnList['total'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('discount') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($salereturnList['total_discount'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('sale_tax') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($salereturnList['total_tax'],2,'.',','); ?></td>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right;padding: 5px;width: 100px;"><b><?php echo $this->lang->line('net_amount') . ": (" . $currency_symbol . ")"; ?></b></th>
                                            <td style="text-align: right;padding: 5px;width: 133px;"><?php echo number_format($salereturnList['grand_total'],2,'.',','); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
