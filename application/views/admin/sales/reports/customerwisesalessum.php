        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/sales/customerwisesalessum/'.$brc_id) ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-left"><?php echo $this->lang->line('customer'); ?></th>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/sales/customerwisesalessum/'); ?>'+val;          
        if(url){
