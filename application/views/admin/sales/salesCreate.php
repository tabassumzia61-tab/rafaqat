...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('sales', 'can_add')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_sales_invoice'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/sales/salesSave') ?>"  id="salessave" class="fromsalessave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="around10">
                                                <div class="row">
                                                    <?php  
                                                    if ($this->rbac->hasPrivilege('sales', 'can_branch')) { ?>
                                                        <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="sale_no" id="sale_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $sale_no; ?>" readonly="readonly"/>
                                                            ...
                                                            <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                                                ...
                                                                <tbody>
                                                                    <tr id="row1">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" name="rate_1" id="rate1"  class="form-control text-right rate" />
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <div class=""> 
                                                                                    <div class="input-group">
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="salessave" class="btn btn-info salessave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_new'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/sales/create/'); ?>'+val;          
        if(url){
    ...
    $(document).ready(function () {
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/sales/salesPrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.salessave', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#salessave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/sales/salesSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
