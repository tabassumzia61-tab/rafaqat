            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('sales_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('sales', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/sales/create/<?php echo $brc_id; ?>" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_sales_invoice'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/sales/searchsales') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:20px 0 0 0px">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                ...
                                <table class="table table-striped table-bordered table-hover sales-list">
                                    <thead>
                                        <tr>
...
<div class="salesinvoiceModal modal fade" id="salesinvoiceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title modal-titles" id="myModalLabel"><?php echo $this->lang->line('sale_invoice'); ?> </h4>
            </div>
            <div class="modal-body modal-salesinvoice-body" style="padding: 8px;width: 100%;display: inline-block;">
            </div>
        </div>
    </div>
</div>
<script>
    ...
    $(document).ready(function () {
        initDatatable('sales-list','admin/sales/getsaleslist/'+brc_id, [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('sales-list','admin/sales/getsearchsaleslist',response.params);
                        }
                      },
...
<script type="text/javascript">
    $(document).ready(function (e) {
        $('.salesinvoiceModal').modal({
            backdrop: 'static',
            keyboard: false,
            show: false
        });
        
        $('#salesinvoiceModal').on('show.bs.modal', function (e) {
            var sale_id = $(e.relatedTarget).data('sales_id');
            var $modalDiv = $(event.delegateTarget);
            var baseUrl = '<?php echo base_url() ?>';
            $('.modal-salesinvoice-body').html("");
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/sales/viewsalesinvoice') ?>",
                dataType: 'text',
                ...
                success: function (response) {
                    ...
                    $('.modal-salesinvoice-body').html(response);
                },
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/sales/index/'); ?>'+val;          
        if(url){
