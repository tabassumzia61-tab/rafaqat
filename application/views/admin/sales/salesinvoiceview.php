    ...
    <div class="row">  
    	<div class="panel panel-default">
            <div class="panel-heading">
                <?php  echo $this->lang->line('invoice_customer_details'); ?>
            </div>
                ...
                <table class="table table-condensed table-striped table-borderless" style="margin-bottom:0;">
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $inv['sale_no']; ?></td>
                        </tr>
                        <tr>
                            <td><b><?php  echo 'Due Date:'; ?></b></td>
                            <td><?php if(!empty($inv['due_date']) || $inv['due_date'] == '0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), strtotime($inv['due_date'])); } ?></td>
