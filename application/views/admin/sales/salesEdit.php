...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('sales', 'can_edit')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_sales_invoice'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/sales/salesUpdateSave/'.$sales['id']) ?>"  id="salessave" class="fromsalessave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" id="sale_date"  type="text" value="<?php if(!empty($sales['date']) && $sales['date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($sales['date'])); } ?>" class="form-control sale_date"/>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="sale_no" id="sale_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $sales['sale_no']; ?>" readonly="readonly"/>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="due_date" id="due_date"  type="text" value="<?php if(!empty($sales['due_date']) && $sales['due_date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($sales['due_date'])); } ?>" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="customer_type" name="customer_type" class="form-control customer_type js-example-basic-single"  >
                                                                ...
                                                                foreach ($ct as $key => $val) { ?>
                                                                    <option value="<?php echo $key ?>" <?php if (set_value('customer_type',$sales['customer_type']) == $key) echo "selected=selected" ?>><?php echo $val ?></option>
                                                                    <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="payment_mode_id" name="payment_mode_id" class="form-control payment_mode_id js-example-basic-single">
                                                                ...
                                                                foreach ($acclist as $accval) { ?>
                                                                    <option value="<?php echo $accval['id'] ?>" <?php if (set_value('payment_mode_id',$sales['payment_mode_id']) == $accval['id']) echo "selected=selected" ?>><?php echo $accval['name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="customer_id" name="customer_id" class="form-control customer_id js-example-basic-single"  >
                                                                ...
                                                                foreach ($customerslist as $val) {
                                                                    if($val['id'] == 1){}else{ ?>
                                                                        <option value="<?php echo $val['id'] ?>" <?php if (set_value('customer_id',$sales['customer_id']) == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                    ...
                                                    <div id="cart_view" class="col-md-12"> 
                                                        <div class="table-responsive">
                                                            <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $orderitem = $this->sales_model->getItemsBysalesID($sales['id']);
                                                                    $rnum = 1;
                                                                    if(!empty($orderitem)){ 
                                                            ...
                                                            <table class="carttable">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <input type="text" placeholder="Total" value="<?php echo number_format($sales['total'],2,'.',','); ?>" name="total" id="total" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control total"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($sales['total_discount'],2,'.',','); ?>" name="discount" id="discount" readonly style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control discount"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" name="total_tax" readonly value="<?php echo number_format($sales['total_tax'],2,'.',','); ?>" id="total_tax" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control total_tax"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
                                                                        <td colspan="2"  class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($sales['grand_total'],2,'.',','); ?>" name="net_amount" id="net_amount" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control net_amount"/></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table> 
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="customer_message" name="customer_message" placeholder=""  class="form-control" style="height: 100px"><?php echo set_value('customer_message',$sales['note']) ?></textarea>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="salessave" class="btn btn-info salessave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var id = '<?php echo $id; ?>';
        var url ='<?php echo site_url('admin/sales/edit/'); ?>'+ id +'/'+val;          
        if(url){
...
<script type="text/javascript">
    var selcustomer_type = '<?php echo $sales['customer_type']; ?>';
    ...
    function getItemDetail(item_obj,item_id,item_details){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/sales/addtocart") ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var customer_id =   '<?php echo set_value('customer_id',$sales['customer_id']) ?>';
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#salessave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/sales/salesUpdatePrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.salessave', function (e) {
            var itemsel = $('.itemsel').val();
            if(itemsel == ''){
                errorMsg('Please Select Order Items Before!');
            }else{
                var $id = '<?php echo $sales['id']; ?>';
                var $this = $(this);
                $this.button('loading');
                $('.salessave').prop("disabled", true);
                var formData = new FormData($('#salessave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/sales/salesUpdateSave/") ?>'+$id,
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
