                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input  name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date', date($this->customlib->getSystemDateFormat())); ?>" readonly="readonly"/>
                                                            ...
                                                            foreach ($attendencetypeslist as $key => $type) {
                                                                ...
                                                                if ($type['key_value'] != "H") {
                                                                    ...
                                                                    if ($value["date"] != "xxx") {
                                                                        ...
                                                                        ?>  type="radio" id="attendencetype<?php echo $value['staff_id'] . "-" . $count; ?>" value="<?php echo $type['id'] ?>" name="attendencetype<?php echo $value['staff_id']; ?>">
