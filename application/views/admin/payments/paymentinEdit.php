...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
            <?php if (($this->rbac->hasPrivilege('payment_in', 'can_edit'))) {
                ?>     
                <div class="col-md-12">           
                    <div class="box box-primary">
                        ...
                        <form id="accvoucherform" action="<?php echo base_url() ?>admin/payments/paymentinedit/<?php echo $id; ?>/<?php echo $brc_id; ?>" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="payment_from" name="payment_from" class="form-control payment_from">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <option value="1" <?php if (set_value('payment_from', $vouchers['payment_type_id']) == 1) echo "selected=selected"; ?> ><?php echo $this->lang->line('customer'); ?></option>
                                                    <option value="3" <?php if (set_value('payment_from', $vouchers['payment_type_id']) ==  3) echo "selected=selected"; ?> ><?php echo $this->lang->line('employee'); ?></option>
                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select autofocus="" id="customer_id" name="customer_id" class="form-control selectval">
                                                                    ...
                                                                    <?php foreach ($customerlist as $customer) { ?>
                                                                        <option value="<?php echo $customer['id'] ?>" <?php if (set_value('customer_id',$vouchers['customer_id']) == $customer['id']) echo "selected=selected"; ?>><?php echo $customer['code'].' - '.$customer['name']; ?></option>
                                                                    <?php } ?>
                                                                </select>
