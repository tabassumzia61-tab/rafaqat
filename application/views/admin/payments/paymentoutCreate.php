                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="payment_to" name="payment_to" class="form-control payment_to">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <option value="2" <?php if (set_value('payment_to', 2) == 2) echo "selected=selected"; ?> ><?php echo $this->lang->line('supplier'); ?></option>
                                                    <option value="3" <?php if (set_value('payment_to')) echo "selected=selected"; ?> ><?php echo $this->lang->line('employee'); ?></option>
                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select autofocus="" id="supplier_id" name="supplier_id" class="form-control selectval">
                                                                    ...
                                                                    <?php foreach ($supplierlist as $supplier) { ?>
                                                                        <option value="<?php echo $supplier['id'] ?>" <?php if (set_value('supplier_id') == $supplier['id']) echo "selected=selected"; ?>><?php echo $supplier['code'].' - '.$supplier['name']; ?></option>
                                                                    <?php } ?>
                                                                </select>
