    <form id="addPayment" action="<?php echo site_url('admin/purchase/received_payment')?>" method="post" onsubmit="return false;" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label><?php echo $this->lang->line('payment_date') ?><span class="required" aria-required="true">*</span></label>
                    <input id="date" name="payment_date" value="<?php if(!empty($payment)) echo $payment->payment_date ?>" class="form-control" type="text">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <!-- /.Start Date -->
                <div class="form-group form-group-bottom">
                    <label><?php echo $this->lang->line('received_amount') ?></label>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group form-group-bottom">
                        ...
                        <select id="method" class="form-control" name="payment_method">
                            <option value="cash" <?php if(!empty($payment)) echo $payment->method == 'Cash'?'selected':'' ?>><?php echo $this->lang->line('cash') ?></option>
                            <option value="ck" <?php if(!empty($payment)) echo $payment->method == 'ck'?'selected':'' ?>><?php echo $this->lang->line('cheque') ?></option>
                            <option value="bank" <?php if(!empty($payment)) echo $payment->method == 'bank'?'selected':'' ?>><?php echo $this->lang->line('bank_transfer') ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="ref box">
                    <div class="col-md-12">
                        <!-- /.Start Date -->
                        <div class="form-group form-group-bottom">
                            <label><?php echo $this->lang->line('ref') ?>.</label>
        ...
        <div class="modal-footer" >
            ...
            <button type="button" id="close" class="btn btn-danger btn-flat pull-left" data-dismiss="modal"><?php echo $this->lang->line('close') ?></button>
            <button type="submit" class="btn bg-olive btn-flat" id="btn" ><?php echo $this->lang->line('save') ?></button>
...
<script>
    function receivedAmount (arg){
        ...
        if(amount > due){
            ...
            document.getElementById('msg').innerHTML = "<?= $this->lang->line('received_amount_is_grater_than_due') ?>";
        }else{
            $('#msg').empty();
