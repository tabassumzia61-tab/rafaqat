        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form id="submit_salebill" action="<?php echo site_url('admin/dispatchitem/save_dispatchitem') ?>" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero">    
                                <h4 class="pagetitleh2"><?php echo $this->lang->line('add_dispatchitem'); ?> </h4>
                                <div class="around10">
...
<script type="text/javascript">
    function get_data_by_campuss(val){
        //alert();
        var url ='<?php echo site_url('admin/dispatchitem/newpurchase/'); ?>'+val;          
        if(url){
    ...
    $(document).ready(function () {
        $(document).on('click', '.submit_salebill', function (e) {
            ...
            if(itemsel == ''){
                ...
                setTimeout(function () {
                    $.ajax({
                        url: '<?php echo site_url("admin/dispatchitem/save_dispatchitem") ?>',
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
