            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('dispatchitem_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('dispatchitem', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/dispatchitem/create" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_dispatchitem'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/dispatchitem/searchdispatchitem') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                <div class="download_label"><?php echo $this->lang->line('dispatchitem_list'); ?></div>
                                <table class="table table-striped table-bordered table-hover dispatchitem-list">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('dispatchitem-list','admin/dispatchitem/getdispatchitemlist', [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('dispatchitem-list','admin/dispatchitem/getsearchdispatchitemlist',response.params);
                        }
                      },
...
<script type="text/javascript">
    function viewDetail(id) {
        $.ajax({
            url: '<?php echo base_url() ?>admin/dispatchitem/getBillDetails/' + id,
            type: "GET",
            data: {id: id},
