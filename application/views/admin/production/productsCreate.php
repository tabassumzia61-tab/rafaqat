                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_product'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/production/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="code" value="<?php echo set_value('code'); ?>" class="form-control" id="code">
                                        ...
                                        <div class="col-md-6 col-md-offset-1"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="subcategory" name="subcategory" class="js-example-basic-single form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="details" name="details" placeholder=""  class="form-control" style="height: 100px"><?php echo set_value('details') ?></textarea>
