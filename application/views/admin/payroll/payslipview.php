                ...
                <div class="">
                    ...
                    <table width="100%" class="paytable2">
                        <tr>
                            ...
                            <th class="text-right"></th> <th class="text-right"><?php echo $this->lang->line('payment_date'); ?>: <?php echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['payment_date'])); ?></th>
                        </tr>
                    </table>
                    <hr/>
                    <table width="100%" class="paytable2" >
...
?>
                        <tr>
                            ...
                            <th class="pttright reborder"><?php echo amountFormat($result["total_earning"]); ?></th>
...
echo amountFormat($basic);?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php $gross_salary = $result["basic"] + $result["total_earning"] - $result["total_deduction"];
