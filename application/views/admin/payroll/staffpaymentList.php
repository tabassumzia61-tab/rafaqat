                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php //echo $title;      ?><?php echo $this->lang->line('add').' '.$this->lang->line('staffpayment'); ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/payroll/staffpayment"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="staff_id" name="staff_id" class="form-control" >
                                        ...
                                        foreach ($staffList as $staff) {
                                            ...
                                            if (set_value('staff_id') == $staff['id']) {
                                    ...
                                    <select id="allowance_type" name="acc_head_id" class="form-control">
                                        ...
                                        <?php
                                            foreach ($paytypeList as $type_val) { ?>
                                                <option value="<?php echo $type_val['id'] ?>" <?php if (set_value('acc_head_id') == $type_val['id']) echo "selected=selected" ?>><?php echo $type_val['type']; ?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date', date($this->customlib->getSystemDateFormat())); ?>" readonly="readonly" />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var staff_id =   '<?php echo set_value('staff_id',$staff_id) ?>';
    ...
    function getStaffBybrachID(brach_id) {
        if (brach_id != "" ) {
            $('#staff_id').html("");
            var base_url = '<?php echo base_url() ?>';
            var div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>';
            var url = "<?php  echo "getStaffByBranch" ?>";
            $.ajax({
                type: "POST",
...
<script type="text/javascript">
    function get_data_by_campuss(val){
        //alert();
        var url ='<?php echo site_url('admin/payroll/staffpayment/'); ?>'+val;          
        if(url){
