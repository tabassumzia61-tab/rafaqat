                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                ...
                                if (!empty($staff["date_of_joining"]) && $staff["date_of_joining"] != '0000-00-00') {
                                    echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($staff['date_of_joining']));
                                }
                                ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        if ($staff['id'] == $logged_in_User['id']) {
                            $a = true;
                        } elseif ($logged_in_User_Role->id == 1 && $logged_in_User_Role->name == "Super Admin") {
                            if ($staff["role_id"] == 1) {
                                if ($staff["role_id"] == 1 && $staff['id'] != $logged_in_User['id']) {
                                    $a = false;
                                } else {
                                    $a = true;
                            ...
                            <div class="tshadow mb25 bozero">
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            <tr>
                                                <td><?php echo $this->lang->line('email'). '/'.$this->lang->line('username'); ?></td>
                                                <td><?php echo $staff['email']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('password'); ?></td>
                                                <td><?php echo $staff['ch_password']; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                if (!empty($staff["dob"]) && $staff["dob"] != '0000-00-00') {
                                                    echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($staff['dob']));
                                                }
                                                ?></td>
                                            </tr>
...
foreach ($staff_payroll as $key => $payroll_value) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><?php echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($payroll_value['payment_date'])); ?></td>
                                                <td><?php
...
echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['timeline_date']));
        ?></span>
                                                </li>
                                                <li>
...
foreach ($staff_leaves as $key => $value) {
    ...
    ?>
                                                <tr>
                                                    ...
                                                    <td class="white-space-nowrap"><?php echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['leave_from'])) . " - " . date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['leave_to'])); ?></td>
                                                    <td><?php echo $value["leave_days"]; ?></td>
                                                    <td><?php echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['date'])); ?></td>
                            ...
                            <div id='timeline_hide_show'>
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="timeline_date" name="timeline_date" value="<?php echo set_value('timeline_date', date($this->customlib->getSystemDateFormat())); ?>" placeholder="" type="text" class="form-control date"  />
