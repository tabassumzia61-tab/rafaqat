                                            ...
                                            <tbody>
                                                ...
                                                foreach ($leave_request as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date($this->customlib->getSystemDateFormat(), strtotime($value["leave_from"])) ?> - <?php echo date($this->customlib->getSystemDateFormat(), strtotime($value["leave_to"])) ?></td>

                                                        <td><?php echo $value["leave_days"]; ?></td>
                                                        <td><?php echo date($this->customlib->getSystemDateFormat(), strtotime($value["date"]));  ?></td>
                                                        <?php
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                            <label><?php echo $this->lang->line('branch'); ?></label><small class="req"> *</small>
                                            <select name="abranch_id" id="abranch_id"  class="form-control">
                                                <option value="" ><?php echo $this->lang->line('select') ?></option>
                                                <?php foreach ($branchlist as $brakey => $bravalue) {
                                                    ?>
                                                    <option value="<?php echo $bravalue["id"] ?>"><?php echo $bravalue["name"] ?></option>
                                                <?php }?>
                                            </select>
                                            <span class="text-danger"><?php echo form_error('abranch_id'); ?></span>
                                        </div>
                                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                        ...
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                            ...
                                            <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                ...
                                                <input type="text" id="applieddate" name="applieddate" value="<?php echo date($this->customlib->getSystemDateFormat()) ?>" class="form-control date">
                                            </div>
                                            <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                                                <label>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function addLeave() {
                                        ...
                                        var date = '<?php echo set_value('date', date($this->customlib->getSystemDateFormat())); ?>';
                                    ...
                                    function getEmployeeName(role) {
                                        ...
                                        $.ajax({
                                            ...
                                            data: {'role': role,'brach_id':brach_id},
                                            dataType: "json",
                                            success: function (data) {
                                    ...
                                    function editRecord(id) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (result) {
                                                ...
                                                $('#abranch_id').val(result.brach_id);
                                        ...
                                        var date_format = '<?php echo $result = strtr($this->customlib->getSystemDateFormat(), ['m' => 'mm', 'd' => 'dd', 'Y' => 'yyyy']) ?>';
