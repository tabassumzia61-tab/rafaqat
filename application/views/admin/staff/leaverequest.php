    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('apply_leave').' '.$this->lang->line('details'); ?></h4>
            </div>
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('select[name="abranch_id"] option[value="' + result.brach_id + '"]').attr("selected", "selected");
