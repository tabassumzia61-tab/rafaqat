                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadding">
                            <div class="loginbg">
                                ...
                                <div class="form-bottom">
                                    ...
                                    ?>
                                    <form action="<?php echo site_url('superadmin/forgotpassword') ?>" method="post">
                                    ...
                                    <a href="<?php echo site_url('superadmin/login') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('superadmin_login'); ?></a>
                                </div>
                            </div>
                        </div>  
                    </div>  
