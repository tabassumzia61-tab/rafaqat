        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/sales/itemwisesalesdet/'.$brc_id) ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-list"></i> <?php echo $this->lang->line('products').' '.$this->lang->line('wise').' '.$this->lang->line('sales').' '.$this->lang->line('details'); ?></h3>
                            </div>                              
                            <div class="box-body">
                                        ...
                                        <tbody id="tbldetail">
                                            ...
                                            if(!empty($salelist)){
                                                ...
                                                <tr>
                                                    ...
                                                    <!--<td></td>-->
                                                    <td><?php echo $salval['product_name']; ?></td>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/sales/itemwisesalesdet/'); ?>'+val;          
        if(url){
