                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_sale_return'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/salesreturn/salesreturnSave') ?>"  id="salesreturnsave" class="fromsalesreturnsave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="salesreturnsave" class="btn btn-info salesreturnsave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_new'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/salesreturn/create/'); ?>'+val;          
        if(url){
    ...
    $(document).ready(function () {
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/salesreturn/salesreturnPrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.salesreturnsave', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#salesreturnsave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/salesreturn/salesreturnSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
