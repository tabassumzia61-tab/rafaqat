            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="pay_amount" name="pay_amount" placeholder="" type="text" class="form-control pay_amount"  value="<?php echo set_value('pay_amount',$cashpaylist['paid_amount']); ?>" />
    ...
    $(document).on('click', '.submit_fees', function (e) {
        ...
        if(amount == ''){
            ...
            if (radioValue == 'paid') {    
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/supplier/updatecashBySupplier") ?>',
                    type: 'post',
                    dataType: 'json',
                    data: {'invoice_id':invoice_id,'paid_types':radioValue,'paid_id':paid_id_re,'paid_amount':amount,'itemsupplierID':itemsupplierID,'payment_mode':payment_mode,'payment_type':payment_type,'description':description,'date':dateforfee},
