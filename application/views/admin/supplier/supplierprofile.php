...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <div class="box box-primary" <?php if ($supplier["is_active"] == 0) { echo "style='background-color:#f0dddd;'"; } ?>>
                    <div class="box-body box-profile">
                        ...
                        ?>
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo $this->media_storage->getImageURL( "uploads/supplier_images/" . $file); ?>" alt="User profile picture">
                        <h3 class="profile-username text-center"><?php echo $supplier['name'] . " " . $supplier['surname']; ?></h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('supplier_id'); ?></b> <a class="pull-right text-aqua"><?php echo $supplier['supplier_id']; ?></a>
                            </li>
                            <?php if (($supplier["is_active"] == 0)) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('date_of_leaving'); ?></b> <a class="pull-right text-aqua"><?php echo $this->customlib->dateformat($supplier['disable_at']); ?></a>
                                </li>
                            <?php }if($supplier["is_active"] == 0) { ?>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('disable_date'); ?></b> <a class="pull-right text-aqua"><?php echo $this->customlib->dateformat($supplier['disable_at']); ?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if ($supplier["is_active"] == 1) { ?>
                            <li class="pull-right"><a  class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('disable'); ?>" onclick="disable_supplier('<?php echo $id; ?>');"></i> <i class="fa fa-thumbs-o-down"></i></a></li>
                        <?php }else if ($supplier["is_active"] == 0) { ?>
                            ...
                            <li class="pull-right"><a href="<?php echo base_url('admin/supplier/enablesupplier/' . $id); ?>" class="text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('enable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_enable_this_record'); ?>');"><i class="fa fa-thumbs-o-up"></i></a></li>
                        <?php }?>
                        <li class="pull-right"><a href="<?php echo base_url('admin/supplier/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>              
                    </ul>
                    <div class="tab-content">
                                    ...
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $this->lang->line(strtolower($supplier['gender'])); ?></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="col-md-5"><?php echo $supplier['address']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('permanent_address'); ?></td>
                                                <td><?php echo $supplier['permanent_address']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="tab-pane" id="documents">
                            <div class="timeline-header no-border">
                                <div class="row">
                                    <?php if ((empty($supplier["cnic_image"])) && (empty($supplier["resignation_letter"])) && (empty($supplier["other_document_file"]))) { ?>
                                        <div class="col-md-12">
                                            <div class="alert alert-info"><?php echo $this->lang->line("no_record_found"); ?></div>
                                        </div>
                                    <?php } else { ?>
                                        <?php if (!empty($supplier["cnic_image"])) { ?>
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="staffprofile">
                                                    <h5><?php echo $this->lang->line('cnic'); ?></h5>
                                                    <a href="<?php echo base_url(); ?>admin/supplier/download/<?php echo $supplier['id'] . "/" . 'cnic_image'; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                        <i class="fa fa-download"></i>
                                                    </a>
                                                    <?php if($this->rbac->hasPrivilege('supplier', 'can_delete')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/supplier/doc_delete/<?php echo $supplier['id'] . "/cnic_image"; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                        ...
                                        <?php } ?>
                                        <?php if (!empty($supplier["resignation_letter"])) { ?>
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="staffprofile">
                                                    <h5><?php echo $this->lang->line('resignation_letter'); ?></h5>
                                                    <a href="<?php echo base_url(); ?>admin/supplier/download/<?php echo $supplier['id'] . "/" . 'resignation_letter'; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                        <i class="fa fa-download"></i>
                                                    </a>
                                                    <?php if($this->rbac->hasPrivilege('supplier', 'can_delete')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/supplier/doc_delete/<?php echo $supplier['id'] . "/resignation_letter"; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                            <i class="fa fa-remove"></i>
                                                        </a>
                                                    <?php } ?>
                                                    <div class="icon">
                                        ...
                                        <?php } ?>
                                        <?php if (!empty($supplier["other_document_file"])) { ?>
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="staffprofile">
                                                    <h5><?php echo $this->lang->line('other_documents'); ?></h5>
                                                    <a href="<?php echo base_url(); ?>admin/supplier/download/<?php echo $supplier['id'] . "/" . 'other_document_file'; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                        <i class="fa fa-download"></i>
                                                    </a>
                                                    <?php if($this->rbac->hasPrivilege('supplier', 'can_delete')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/supplier/doc_delete/<?php echo $supplier['id'] . "/other_document_file"; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                            <i class="fa fa-remove"></i>
                                                        </a>
                                                    <?php } ?>
                                                    <div class="icon">
...
<div class="modal fade" id="myguarantorModal" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="guarantorform" name="guarantorform" method="post" action="<?php echo base_url() . "admin/supplier/addguarantor" ?>"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <?php echo $this->customlib->getCSRF(); ?>
                    <div id='guarantor_hide_show'>
                        <input type="hidden" name="supplier_id" value="<?php echo $supplier["id"] ?>" id="supplier_id">  
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form  id="editguarantorform" name="guarantorform" method="post" action="<?php echo base_url() . "admin/supplier/editguarantor" ?>"  enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('disable_supplier'); ?></h4>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        $("#disablebtn").on('submit', (function (e) {
            var supplier_id = '<?php echo set_value('supplier_id',$id) ?>';
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url('admin/supplier/disablestsupplier/') ?>" + supplier_id,
                type: "POST",
...
<script type="text/javascript">
    ...
    $("#guarantorform").on('submit', (function (e) {
        ...
        $.ajax({
            url: "<?php echo site_url("admin/supplier/addguarantor") ?>",
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
    ...
    $('.edit_guarantor').click(function(){
       ...
       var id = $(this).attr('data-id');
        $.ajax({
                url: "<?php echo site_url("admin/supplier/getguarantoredit") ?>",
                type: "POST",
                data: {id:id},
                dataType: 'json',
    ...
    $("#editguarantorform").on('submit', (function (e) {
        ...
        var $this = $(this).find("button[type=submit]:focus");
        $.ajax({
            url: "<?php echo site_url("admin/supplier/editguarantor") ?>",
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
    ...
    function delete_guarantor(id) {
        if (confirm('<?php echo $this->lang->line("delete_confirm") ?>')) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/supplier/delete_guarantor/' + id,
                success: function (res) {
    ...
    $('.info_guarantor').click(function(){
        ...
        var id = $(this).attr('data-id');
        $.ajax({
                url: "<?php echo site_url("admin/supplier/getguarantorinfo") ?>",
                type: "POST",
                data: {id:id},
                dataType: 'json',
                success: function (response) {
