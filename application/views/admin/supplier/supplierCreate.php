            ...
            <?php if ($this->rbac->hasPrivilege('supplier', 'can_add')) { ?>
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/supplier/create/'.$brc_id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="supplier_id" name="supplier_id"  placeholder="" type="text" class="form-control"  style="background-color:#eee3e3;" readonly value="<?php echo set_value('supplier_id',$supplier_id) ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger"><?php echo form_error('payment_limit'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
