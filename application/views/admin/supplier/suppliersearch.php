    ...
    <section class="content-header">
        ...
        <?php if ($this->rbac->hasPrivilege('staff', 'can_add')) {?>
            <small class="pull-right">
                <a href="<?php echo base_url(); ?>admin/supplier/create/<?php echo $brc_id; ?>" class="btn btn-primary btn-sm">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="<?php echo site_url('admin/supplier/index/'.$brc_id) ?>" method="post" class="">
                                ...
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('payment_limit'); ?></th>
                                            ...
                                            foreach ($resultlist as $supplier) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name">
                                                        ...
                                                        if ($supplier['address'] != "") {
                                                            ?>
                                                            <i class="fa fa-building"></i> <?php echo $supplier['address'].' '.$supplier['area_name'].' '.$supplier['city_name'] ?>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
                                                    <td class="mailbox-name">
                                                        <?php
                                                        if ($supplier['payment_limit'] != "") {
                                                            ?>
                                                            <?php echo  number_format($supplier['payment_limit'], 0, '.', ',') ?>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
                                                    <td class="pull-right">
                                                        <?php if ($this->rbac->hasPrivilege('show_supplier_ledger', 'can_view')) { ?>
                                                            <a class="btn btn-primary btn-xs" title="<?php echo $this->lang->line('show_supplier_ledger'); ?>"  href="<?php echo base_url() . "admin/supplier/ledgers/" . $supplier["id"] ?>"><i class="fa fa-file-text-o"></i></a>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('supplier', 'can_edit')) {
                                                                if($supplier['id'] == 1){}else{ ?>
                                                                    <a href="<?php echo base_url(); ?>admin/supplier/edit/<?php echo $supplier['id'] ?>/<?php echo $supplier['brc_id'] ?>" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    <div class="staffinfo-box">
                                                        ...
                                                        <div class="overlay3">
                                                            <div class="stafficons">
                                                                <?php if ($this->rbac->hasPrivilege('show_supplier_ledger', 'can_view')) { ?>
                                                                    <a title="<?php echo $this->lang->line('show_supplier_ledger'); ?>"  href="<?php echo base_url() . "admin/supplier/ledgers/" . $supplier["id"] ?>"><i class="fa fa-file-text-o"></i></a>
                                                                <?php } ?>
                                                                <?php if ($this->rbac->hasPrivilege('supplier', 'can_view')) { ?>
                                                                ...
                                                                <?php if ($this->rbac->hasPrivilege('supplier', 'can_edit')) { 
                                                                    if($supplier['id'] == 1){}else{ ?>
                                                                        <a title="<?php echo $this->lang->line('edit'); ?>"  href="<?php echo base_url() . "admin/supplier/edit/" . $supplier["id"].'/'.$supplier["brc_id"]; ?>"><i class=" fa fa-pencil"></i></a>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/supplier/index/'); ?>'+val;          
        if(url){
