...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>uploads/system_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo(); ?>" rel="shortcut icon" type="image/x-icon">
        <!-- CSS -->
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/usertemplate/assets/css/jquery.mCustomScrollbar.min.css">
    </head>
    <body>
        <!-- Top content -->
                                ...
                                <div class="loginbg">  
                                   <!-- <div class="form-top">
                                        <div class="form-top-left logowidth">
                                            <img src="<?php echo base_url(); ?>uploads/system_content/admin_logo/<?php echo $this->setting_model->getAdminlogo(); ?>" />    
                                        </div>
                                    </div> -->
                                    <div class="form-bottom">
                                        <h4 class="font-white bolds"><?php echo $this->lang->line('login_to_your_account'); ?></h4>
                                        <?php
                                        ...
                                        ?>
                                        <form action="<?php echo site_url('superadmin/login') ?>" method="post">
                                            ...
                                            <button type="submit" class="btn"><?php echo $this->lang->line('login'); ?> &nbsp; <i class="fa fa-sign-in"></i></button>
                                        </form>
                                        <a href="<?php echo site_url('superadmin/forgotpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_your_password'); ?>?</a>
                                    </div>
                                </div>
                            </div> 
                        </div>  
        ...
        <script src="<?php echo base_url(); ?>assets/usertemplate/assets/js/jquery.mCustomScrollbar.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/usertemplate/assets/js/jquery.mousewheel.min.js"></script>
    </body>
</html>
