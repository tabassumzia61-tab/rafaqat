        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="purchase_edit_sale_from" action="<?php echo site_url('admin/issueitem/save_edit_issueitem/').$result["id"]; ?>" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">

                            <div class="tshadow mb25 bozero">    

                                <h4 class="pagetitleh2"><?php echo $this->lang->line('edit_issueitem'); ?> </h4>
                                ...
                                <div class="around10">
                                    ...
                                    <input type="hidden" id="issueitem_bill_id" name="issueitem_bill_id" value="<?php echo set_value('issueitem_bill_id',$result['id']); ?>" />
                                    <?php 
                                        $getproductdetail = $this->issueitem_model->getbilldetilproductbyid($result["id"]); 
    ...
    $(document).ready(function () {
        $(document).on('click', '.purchase_edit_sale_add', function (e) {
            ...
            if(itemsel == ''){
                ...
                var $this = $(this);
                var $id = $('#issueitem_bill_id').val();
                var formData = new FormData($('#purchase_edit_sale_from')[0]);
                $this.button('loading');
                setTimeout(function () {
                    $.ajax({
                        url: '<?php echo site_url("admin/issueitem/save_edit_issueitem/") ?>'+$id,
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
