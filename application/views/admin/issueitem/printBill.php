            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5><?php echo $this->lang->line('reference_no') . " #"; ?><?php echo $result["bill_no"] ?></h5>
                            </td>
                            <td align="right"><h5><?php echo $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getSystemDateFormat(true, true), strtotime($result['date'])) ?></h5>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <th width="20%"><?php echo $this->lang->line('supervisor'); ?></th>
                            <td width="25%"><?php echo $result["staff_name"]; ?></td>
                        </tr> 
                    </table>
                    <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px">
                    <table class="printablea4" id="testreport" width="100%">
                        ...
                        $j = 1;
                        foreach ($cart as $bill) {
                            $product = $this->db->get_where('products', array( 'id' => $bill->id ))->row();
                            ?>
                            <tr>
                                <td><?php echo $j; ?></td>
                                <!-- <td width="20%"><?php //echo $bill["cat_name"]; ?></td> -->
                    ...
                    <table class="printablea4" width="100%">
                        <?php if (!empty($result["subtotal"])) { ?>
                            <tr>

                                <th width="20%"><?php echo $this->lang->line('total') . " (" . $currency_symbol . ")"; ?></th>

                                <td align="left" width="80%"><?php echo $result["subtotal"]; ?></td>
                            </tr>
                        <?php } ?>
                        ...
                        if ((!empty($result["discount"])) && (!empty($result["tax"]))) {
                            if (!empty($result["grand_total"])) {
                                ?>
                                <tr>
                                    <th><?php echo $this->lang->line('grand_total') . " (" . $currency_symbol . ")";
                            ?></th>

                                    <td align="left"><?php echo $result["grand_total"]; ?></td>
                        ...
                        //if ((!empty($result["discount"])) && (!empty($result["tax"]))) {
                            if (!empty($result["paid_amount"])) {
                                ?>
                                <tr>
                                    <th><?php echo $this->lang->line('paid_amount') . " (" . $currency_symbol . ")";
                            ?></th>
