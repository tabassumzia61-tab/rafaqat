<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if (($this->rbac->hasPrivilege('city', 'can_add')) || ($this->rbac->hasPrivilege('city', 'can_edit'))) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        $url = "";
                        if (!empty($name)) {
                            $url = base_url() . "admin/city/edit/" . $id;
                        } else {
            ...
            ?>">             
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('city_list'); ?></h3>
                        <div class="box-tools pull-right"> 
                        </div><!-- /.box-tools -->                 
                    </div>
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('city_list'); ?></div>
                                ...
                                <tbody>
                                    ...
                                    if(!empty($resultlist)){
                                        foreach ($resultlist as $val) { ?>
                                            ...
                                            <?php
                                                $statelist = $this->city_model->getstatebycountry($val['country_id']); 
                                                if(!empty($statelist)){
                                                    foreach ($statelist as $state_key => $state_val) { ?>
                                                        ...
                                                        <?php 
                                                            $citylist = $this->city_model->getcitybycountrybystate($val['country_id'],$state_val['state_id']);
                                                            if(!empty($citylist)){
                                                                foreach ($citylist as $city_key => $city_val) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td></td>
                                                                        <td>
                                                                            <a href="#" data-toggle="popover" class="detail_popover"><?php echo $city_val['name']; ?></a>
                                                                            <div class="show_detail_popover" style="display: none">
                                                                                ...
                                                                                if ($city_val['note'] == "") {
                                                                                    ...
                                                                                    ?>
                                                                                    <p class="text text-info"><?php echo $city_val['note']; ?></p>
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                            </div>
                                                                        ...
                                                                        <td  class="mailbox-date text-right">
                                                                            <?php if ($this->rbac->hasPrivilege('city', 'can_edit')) { ?>
                                                                                <a href="<?php echo base_url(); ?>admin/city/edit/<?php echo $city_val['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                                    <i class="fa fa-pencil"></i>
                                                                                </a>
                                                                            <?php } ?>
                                                                            <?php if ($this->rbac->hasPrivilege('city', 'can_delete')) { ?>
                                                                                <a href="<?php echo base_url(); ?>admin/city/delete/<?php echo $city_val['id'] ?>" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
