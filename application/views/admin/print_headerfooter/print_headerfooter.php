                            ...
                            <form role="form" id="form3" enctype="multipart/form-data" action="<?php echo site_url('admin/print_headerfooter/edit') ?>" class="" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group"><label><?php echo $this->lang->line('footer_content'); ?> </label>
                                            <textarea id="admission_textarea" name="admission_message" class="form-control" style="height: 250px">
                            ...
                            <form role="form" id="form3" enctype="multipart/form-data" action="<?php echo site_url('admin/print_headerfooter/edit') ?>" class="" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group"><label><?php echo $this->lang->line('footer_content'); ?></label>
                                            <textarea id="admission_textarea" name="online_exam_message" class="form-control" style="height: 250px">
