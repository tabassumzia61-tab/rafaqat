            ...
            <?php if (($this->rbac->hasPrivilege('department', 'can_add')) || ($this->rbac->hasPrivilege('department', 'can_edit'))) {
                ...
                <div class="col-md-4">           
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/department/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                    ...
                                    foreach ($departmenttype as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date text-right no-print">
                                                <div class="btn-group actions_dropdown_wrap">
                                                  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Actions <span class="caret"></span>
                                                  </button>
                                                  <ul class="dropdown-menu">
                                                    <li><?php if ($this->rbac->hasPrivilege('department', 'can_edit')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/department/edit/<?php echo $value['id'] ?>" class=""  title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>admin/department/delete/<?php echo $value['id'] ?>" class="" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>')";>
...
<script type="text/javascript">
    function get_data_by_campuss(val){
        //alert();
        var url ='<?php echo site_url('admin/department/department/'); ?>'+val;          
        if(url){
            window.location.href = url; 
        }
    }
    function get_department_by_campus(url){          
        if(url){
            window.location.href = url; 
        }
    } 
