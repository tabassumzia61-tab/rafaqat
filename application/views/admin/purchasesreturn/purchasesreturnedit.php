...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('purchasesreturn', 'can_edit')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_purchase'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/purchasesreturn/purchasesreturnUpdateSave/'.$purchasesreturn['id']) ?>"  id="purchasesreturnsave" class="frompurchasesreturnsave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="around10">
                                                <div class="row">
                                                    <?php  
                                                    if ($this->rbac->hasPrivilege('purchasesreturn', 'can_branch')) { ?>
                                                        <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" id="purchase_date"  type="text" value="<?php if(!empty($purchasesreturn['date']) && $purchasesreturn['date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($purchasesreturn['date'])); } ?>" class="form-control purchase_date"/>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="purchase_no" id="purchase_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $purchasesreturn['purchase_no']; ?>" readonly="readonly"/>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <!-- <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="due_date" id="due_date"  type="text" value="<?php //if(!empty($purchasesreturn['due_date']) && $purchasesreturn['due_date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($purchasesreturn['due_date'])); } ?>" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="supplier_type" name="supplier_type" class="form-control supplier_type js-example-basic-single"  >
                                                                ...
                                                                foreach ($ct as $key => $val) { ?>
                                                                    <option value="<?php echo $key ?>" <?php if (set_value('supplier_type',$purchasesreturn['supplier_type']) == $key) echo "selected=selected" ?>><?php echo $val ?></option>
                                                                    <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="payment_mode_id" name="payment_mode_id" class="form-control payment_mode_id js-example-basic-single">
                                                                ...
                                                                foreach ($acclist as $accval) { ?>
                                                                    <option value="<?php echo $accval['id'] ?>" <?php if (set_value('payment_mode_id',$purchasesreturn['payment_mode_id']) == $accval['id']) echo "selected=selected" ?>><?php echo $accval['name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="supplier_id" name="supplier_id" class="form-control supplier_id js-example-basic-single"  >
                                                                ...
                                                                foreach ($supplierlist as $val) {
                                                                    if($val['id'] == 1){}else{ ?>
                                                                        <option value="<?php echo $val['id'] ?>" <?php if (set_value('supplier_id',$purchasesreturn['supplier_id']) == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                            ...
                                                            <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                                                <thead>
                                                                    <tr class="font13 white-space-nowrap">
                                                                        ...
                                                                        <th class="text-right" width="8%"><?php echo $this->lang->line('amount');// . " (" . $currency_symbol . ")"; ?></th>
                                                                        <th class="text-right" width="2%"></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <?php
                                                                    $orderitem = $this->purchasesreturn_model->getItemsBypurchasesreturnID($purchasesreturn['id']);
                                                                    $rnum = 1;
                                                                    if(!empty($orderitem)){ 
                                                                        foreach ($orderitem as $oikey => $oival) { ?> 
                                                                            ...
                                                                            <tr id="row<?php echo $rnum; ?>">
                                                                                ...
                                                                                <td class="text-right">
                                                                                    <input type="text" name="unit_1" id="unit1"  class="form-control text-right unit" style="background-color:#eee3e3;" value="<?php echo $oival['unit']; ?>" readonly />
                                                                                </td>
                                                                                <td class="text-right">
                                                                                    <input type="text" name="rate_<?php echo $rnum; ?>" id="rate<?php echo $rnum; ?>"  class="form-control text-right rate" value="<?php echo $oival['net_unit_cost']; ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/>
                                                                                </td>
                                                                                <td class="text-right">
                                                                                    <div class=""> 
                                                                                            <div class="input-group">
                                                            ...
                                                            <table class="carttable">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <input type="text" placeholder="Total" value="<?php echo number_format($purchasesreturn['total'],2,'.',','); ?>" name="total" id="total" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control total"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchasesreturn['total_discount'],2,'.',','); ?>" name="discount" id="discount" readonly style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control discount"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchasesreturn['total'] - $purchasesreturn['total_discount'],2,'.',','); ?>" name="exclusive" id="exclusive" readonly style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control exclusive"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" name="total_tax" readonly value="<?php echo number_format($purchasesreturn['total_tax'],2,'.',','); ?>" id="total_tax" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control total_tax"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('net_amount'); //. " (" . $currency_symbol . ")"; ?></th>
                                                                        <td colspan="2"  class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchasesreturn['grand_total'],2,'.',','); ?>" name="net_amount" id="net_amount" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control net_amount"/></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table> 
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="supplier_message" name="supplier_message" placeholder=""  class="form-control" style="height: 100px"><?php echo set_value('supplier_message',$purchasesreturn['note']) ?></textarea>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="purchasesreturnsave" class="btn btn-info purchasesreturnsave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var id = '<?php echo $id; ?>';
        var url ='<?php echo site_url('admin/purchasesreturn/edit/'); ?>'+ id +"/"+ val;          
        if(url){
...
<script type="text/javascript">
    var selsupplier_type = '<?php echo $purchasesreturn['supplier_type']; ?>';
    window.onload = function(){
        if(selsupplier_type == 1){
            $('.cshow').hide();
            $('.paymentmode').show();
        }else{
            $('.cshow').show();
    ...
    function getItemDetail(item_obj,item_id,item_details){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/purchasesreturn/addtocart") ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var supplier_id =   '<?php echo set_value('supplier_id',$purchasesreturn['supplier_id']) ?>';
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#purchasesreturnsave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/purchasesreturn/purchasesreturnUpdatePrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.purchasesreturnsave', function (e) {
            var itemsel = $('.itemsel').val();
            if(itemsel == ''){
                errorMsg('Please Select Order Items Before!');
            }else{
                var $id = '<?php echo $purchasesreturn['id']; ?>';
                var $this = $(this);
                $this.button('loading');
                $('.purchasesreturnsave').prop("disabled", true);
                var formData = new FormData($('#purchasesreturnsave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/purchasesreturn/purchasesreturnUpdateSave/") ?>'+$id,
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
                    ...
                    success: function (data, status, xhr) {
                        if (data.status == "fail") {
                            $('.purchasesreturnsave').prop("disabled", false);
                            $this.button('reset');
                            var message = "";
