        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/purchases/itemwisepurchasesdet/'.$brc_id) ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                <?php  
                                if ($this->rbac->hasPrivilege('produts_wise_purchases_details', 'can_branch')) { ?>
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="item_id" name="item_id" class="form-control selectval">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php foreach ($productslist as $itm_val) { ?>
                                                    <option value="<?php echo $itm_val['id'] ?>" <?php if (set_value('item_id') == $itm_val['id']) echo "selected=selected"; ?>><?php echo $itm_val['name']; ?></option>
                                            <?php } ?>
                                        </select>
                    ...
                    <div class="row">
                        <div class="">
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-list"></i> <?php echo $this->lang->line('products').' '.$this->lang->line('wise').' '.$this->lang->line('purchases').' '.$this->lang->line('details'); ?></h3>
                            </div>                              
                            <div class="box-body">
                                        ...
                                        <tbody id="tbldetail">
                                            ...
                                            if(!empty($purchaseslist)){
                                                ...
                                                <tr>
                                                    ...
                                                    <!--<td></td>-->
                                                    <td><?php echo $purval['product_name']; ?></td>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/purchases/itemwisepurchasesdet/'); ?>'+val;          
        if(url){
