        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/purchases/itemwisepurchasessum/'.$brc_id) ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                <?php  
                                if ($this->rbac->hasPrivilege('produts_wise_purchases_summary', 'can_branch')) { ?>
                                    <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-list"></i> <?php echo $this->lang->line('products').' '.$this->lang->line('wise').' '.$this->lang->line('purchases').' '.$this->lang->line('summary'); ?></h3>
                            </div>                              
                            <div class="box-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-left"><?php echo $this->lang->line('products'); ?></th>
