            ...
            <?php if ($this->rbac->hasPrivilege('purchasesreturn', 'can_add')) { ?>
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/purchasesreturn/purchasesreturnSave') ?>"  id="purchasesreturnsave" class="frompurchasesreturnsave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                <div class="pull-right">                       
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="purchasesreturnsave" class="btn btn-info purchasesreturnsave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_new'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/purchasesreturn/create/'); ?>'+val;          
        if(url){
    ...
    $(document).ready(function () {
        ...
        $(document).on('click','.purchasesreturnsave', function (e) {
            ...
            if(itemsel == ''){
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/purchasesreturn/purchasesreturnSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
