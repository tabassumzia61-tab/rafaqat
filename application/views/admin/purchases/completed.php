            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('purchase_completed_list'); ?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/purchases/searchcompleted') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:0px">
                            <div class="box-header ptbnull">
                                <h3 class="box-title"><?php echo $this->lang->line('purchases_list'); ?></h3>
                            </div>  
                            <div class="mailbox-messages" style="margin-top: 15px;">
                                <div class="download_label"><?php echo $this->lang->line('purchases_list'); ?></div>
                                <table class="table table-striped table-bordered table-hover completed-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('product_rate'); ?></th>
                                            <th><?php echo $this->lang->line('total'); ?></th>
                                            <th><?php echo $this->lang->line('khoya_qty'); ?></th>
                                            <th><?php echo $this->lang->line('khoya_per_qty'); ?></th>
                                            <th><?php echo $this->lang->line('khoya_rate'); ?></th>
                                            <th><?php echo $this->lang->line('total'); ?></th>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('completed-list','admin/purchases/getcompletedlist', [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('completed-list','admin/purchases/getsearchcompletedlist',response.params);
                        }
                      },
