                                ...
                                foreach ($cartItem as $option) { 
                                    if($option->id == 1){ 
                                        ...
                                        <tr>    
                                            ...
                                            <td>
                                                <input class="form-control text-center" onkeyup="myFunctionkhoya(this)" name="khoya_par[]" type="text" value="<?php if(!empty($khoyadet->khoya_par)){ echo (float)$khoyadet->khoya_par; }else{ echo '7'; } ?>"/>
                                            </td>          
                                            <td><input class="form-control text-center" id="rkhoya" name="khoya_qty[]" type="text" value="<?php if(!empty($khoyadet->khoya_quantity)){ echo (float)$khoyadet->khoya_quantity; }else{ echo (float)$khy_t; } ?>" /></td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-footer">
                    <?php if ($this->rbac->hasPrivilege('add_khoya', 'can_add')) { ?>
