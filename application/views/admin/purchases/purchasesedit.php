...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('purchases', 'can_edit')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/purchases/purchasesUpdateSave/'.$purchases['id']) ?>"  id="purchasessave" class="frompurchasessave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" id="purchase_date"  type="text" value="<?php if(!empty($purchases['date']) && $purchases['date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($purchases['date'])); } ?>" class="form-control purchase_date"/>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="purchase_no" id="purchase_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $purchases['purchase_no']; ?>" readonly="readonly"/>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <!-- <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="due_date" id="due_date"  type="text" value="<?php //if(!empty($purchases['due_date']) && $purchases['due_date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($purchases['due_date'])); } ?>" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="supplier_type" name="supplier_type" class="form-control supplier_type js-example-basic-single"  >
                                                                ...
                                                                foreach ($ct as $key => $val) { ?>
                                                                    <option value="<?php echo $key ?>" <?php if (set_value('supplier_type',$purchases['supplier_type']) == $key) echo "selected=selected" ?>><?php echo $val ?></option>
                                                                    <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="payment_mode_id" name="payment_mode_id" class="form-control payment_mode_id js-example-basic-single">
                                                                ...
                                                                foreach ($acclist as $accval) { ?>
                                                                    <option value="<?php echo $accval['id'] ?>" <?php if (set_value('payment_mode_id',$purchases['payment_mode_id']) == $accval['id']) echo "selected=selected" ?>><?php echo $accval['name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="supplier_id" name="supplier_id" class="form-control supplier_id js-example-basic-single"  >
                                                                ...
                                                                foreach ($supplierlist as $val) {
                                                                    if($val['id'] == 1){}else{ ?>
                                                                        <option value="<?php echo $val['id'] ?>" <?php if (set_value('supplier_id',$purchases['supplier_id']) == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                    ...
                                                    <div id="cart_view" class="col-md-12"> 
                                                        <div class="table-responsive">
                                                            <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $orderitem = $this->purchases_model->getItemsBypurchasesID($purchases['id']);
                                                                    $rnum = 1;
                                                                    if(!empty($orderitem)){ 
                                                            ...
                                                            <table class="carttable">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <input type="text" placeholder="Total" value="<?php echo number_format($purchases['total'],2,'.',','); ?>" name="total" id="total" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control total"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchases['total_discount'],2,'.',','); ?>" name="discount" id="discount" readonly style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control discount"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchases['total'] - $purchases['total_discount'],2,'.',','); ?>" name="exclusive" id="exclusive" readonly style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control exclusive"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" name="total_tax" readonly value="<?php echo number_format($purchases['total_tax'],2,'.',','); ?>" id="total_tax" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control total_tax"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('net_amount'); //. " (" . $currency_symbol . ")"; ?></th>
                                                                        <td colspan="2"  class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($purchases['grand_total'],2,'.',','); ?>" name="net_amount" id="net_amount" style="width: 70%; float: right;background-color:#eee3e3 !important;" class="form-control net_amount"/></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table> 
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="supplier_message" name="supplier_message" placeholder=""  class="form-control" style="height: 100px"><?php echo set_value('supplier_message',$purchases['note']) ?></textarea>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="purchasessave" class="btn btn-info purchasessave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var id = '<?php echo $id; ?>';
        var url ='<?php echo site_url('admin/purchases/edit/'); ?>'+ id +"/"+ val;          
        if(url){
...
<script type="text/javascript">
    var selsupplier_type = '<?php echo $purchases['supplier_type']; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var supplier_id =   '<?php echo set_value('supplier_id',$purchases['supplier_id']) ?>';
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/purchases/purchasesUpdatePrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.purchasessave', function (e) {
            ...
            if(itemsel == ''){
                ...
                var $id = '<?php echo $purchases['id']; ?>';
                var $this = $(this);
                $this.button('loading');
                $('.purchasessave').prop("disabled", true);
                var formData = new FormData($('#purchasessave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/purchases/purchasesUpdateSave/") ?>'+$id,
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
