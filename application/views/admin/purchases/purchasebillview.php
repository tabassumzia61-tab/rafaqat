    ...
    <div class="row">  
    	<div class="panel panel-default">
            <div class="panel-heading">
                <?php  echo $this->lang->line('bill_supplier_details'); ?>
            </div>
                ...
                <table class="table table-condensed table-striped table-borderless" style="margin-bottom:0;">
                    <tbody>
                        <tr>
                            ...
                            <td><b><?php  echo 'Bill No#'; ?></b></td>
                            <td><?php echo $inv['purchase_no']; ?></td>
                        </tr>
                        <tr>
                            <td><b><?php  echo 'Supplier ID :'; ?></b></td>
                            <td><?php echo $inv['supplier_no']; ?></td>
    	...
    	<div class="panel panel-default">
            ...
            <div class="panel-body">
                            ...
                            if(!empty($inv['orderitem'])){ 
                                foreach ($inv['orderitem'] as $oi_key => $oi_val) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $oi_val['net_unit_cost']; ?></td>
                ...
                <table class="carttable" style="width: 35%;display: block;float: right;">
                    <tbody>
                        <tr>
                            <th style="padding-right:130px"><?php echo $this->lang->line('gross_amount'); //. " (" . $currency_symbol . ")"; ?></th>
                            <td class="text-right"><?php echo number_format($inv['total'],2,'.',','); ?></td>
                        </tr>
                        <tr>
                            <th style="padding-right:130px"><?php echo $this->lang->line('discount');// . " (" . $currency_symbol . ")"; ?></th>
                            <td class="text-right"><?php echo number_format($inv['total_discount'],2,'.',','); ?></td>
                        </tr>
                        <tr>
                            <th style="padding-right:130px"><?php echo $this->lang->line('exclusive_of_gst');// . " (" . $currency_symbol . ")"; ?></th>
                            <td class="text-right"><?php echo number_format($inv['total'] - $inv['total_discount'],2,'.',','); ?></td>
                        </tr>
                        <tr>
                            <th style="padding-right:130px"><?php echo $this->lang->line('total').' '.$this->lang->line('gst');// . " (" . $currency_symbol . ")"; ?></th>
