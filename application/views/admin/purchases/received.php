            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('purchase_received_list'); ?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/purchases/searchreceived') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:0px">
                            <div class="mailbox-messages" style="margin-top: 15px;">
                                ...
                                <table class="table table-striped table-bordered table-hover received-list">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('received-list','admin/purchases/getreceivedlist', [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('received-list','admin/purchases/getsearchreceivedlist',response.params);
                        }
                      },
