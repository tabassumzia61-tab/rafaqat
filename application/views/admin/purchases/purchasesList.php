            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('purchases_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('purchases', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/purchases/create/<?php echo $brc_id; ?>" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_purchase_bill'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/purchases/searchpurchases') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:20px 0 0 0px">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                ...
                                <table class="table table-striped table-bordered table-hover purchases-list">
                                    <thead>
                                        <tr>
    ...
    <div class="modal-dialog " style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title modal-titles" id="myModalLabel"><?php echo $this->lang->line('purchase_bill'); ?> </h4>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('purchases-list','admin/purchases/getpurchaseslist/'+brc_id, [],[], 100,
            [
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/purchases/index/'); ?>'+val;          
        if(url){
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('purchases-list','admin/purchases/getsearchpurchaseslist',response.params);
                        }
                      },
...
<script type="text/javascript">
    $(document).ready(function (e) {
        ...
        $('#purchasebillModal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/purchases/viewpurchasebill') ?>",
                dataType: 'text',
