            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5><?php echo $this->lang->line('invoice_no') . " #"; ?><?php echo $result["purchase_no"] ?></h5>
                            </td>
                    ...
                    <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <th width="20%"><?php echo $this->lang->line('customer'); ?></th>
                    ...
                    <table class="printablea4" id="testreport" width="100%">
                        ...
                        foreach ($cart as $bill) { ?>
                            <tr>
                                ...
                                <td><?php echo $bill["real_unit_cost"]; ?></td>
                                <td align="right"><?php echo $bill["subtotal"]; ?></td>
                            </tr>
                            <?php
                            $j++;
                        }
                    ...
                    <table class="printablea4" width="100%">
                        ...
                        <?php } ?>
                                <?php if (!empty($result["total_discount"])) { ?>
                            <tr>
                                <th><?php echo $this->lang->line('discount') . " (" . $currency_symbol . ")";
                                    ;
                                    ?></th>

                                <td align="left"><?php echo $result["total_discount"]; ?></td>

                            </tr>
                                <?php } ?>
                                <?php if (!empty($result["total_tax"])) { ?>
                            <tr>
                                <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")";
                                ;
                                ?></th>

                                <td align="left"><?php echo $result["total_tax"]; ?></td>

                            </tr>
                        <?php } ?>
                        <?php
                        if ((!empty($result["total_discount"])) && (!empty($result["total_tax"]))) {
