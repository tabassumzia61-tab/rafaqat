...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    ...
    $col_num='';
      ...
      ?>
    <div class="col-xl-<?php echo $col_num; ?>">
      <div class="card mb-4">
        <div class="card-body">
            <div class="card">
                <h5 class="card-header"><?php echo "Category list";?> </h5>
                <div class="table-responsive text-nowrap">
                    <table class="table table-hover table-striped table-bordered display nowrap" id="categoriesTable">
                        <thead>
                            <tr>
                                <th width="20px"><?php echo $this->lang->line('image'); ?></th>
