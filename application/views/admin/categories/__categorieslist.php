            ...
            if (($this->rbac->hasPrivilege('categories', 'can_add')) || ($this->rbac->hasPrivilege('categories', 'can_edit'))) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        $url = "";
                        if (!empty($name)) {
                            $url = base_url() . "admin/categories/edit/" . $id;
                        } else {
                        ...
                        <form id="form1" action="<?php echo $url ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('category').' '.$this->lang->line('code'); ?></label> <small class="req">*</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('parent_category'); ?></label>
            ...
            ?>">             
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('categories_list'); ?></h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->                 
                    </div>
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('categories_list'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td  class="mailbox-date text-right">
                                                <?php if ($this->rbac->hasPrivilege('categories', 'can_edit')) { ?>
                                                    <a href="<?php echo base_url(); ?>admin/categories/edit/<?php echo $val['id'] ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                <?php } ?>
                                                <?php if ($this->rbac->hasPrivilege('categories', 'can_delete')) { ?>
                                                    <a href="<?php echo base_url(); ?>admin/categories/delete/<?php echo $val['id'] ?>" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
