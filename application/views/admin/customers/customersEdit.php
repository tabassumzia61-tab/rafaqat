                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_customers'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url("admin/customers/edit/" . $id.'/'.$brc_id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="customers_id" name="customers_id"  style="background-color:#eee3e3;" readonly  placeholder="" type="text" class="form-control"  value="<?php echo set_value('customers_id',$customers['customers_id']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name',$customers['name']); ?>" />
                                            ...
                                            <!-- <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="surname" name="surname" placeholder="" type="text" class="form-control"  value="<?php echo set_value('surname',$customers['surname']); ?>" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="gender">
                                                        ...
                                                        foreach ($genderList as $key => $value) {
                                                            ?>
                                                            <option value="<?php echo $key; ?>" <?php if ($customers['gender'] == $key) { echo "selected"; } ?> ><?php echo $value; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="phone" name="phone" placeholder="" type="text" class="form-control"  value="<?php echo set_value('phone',$customers['phone']); ?>" />
                                ...
                                <div class="tshadow mb25 bozero">
                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="company" name="company" placeholder="" type="text" class="form-control"  value="<?php echo set_value('company',$customers['company']); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="text" name="email" placeholder="" type="text" class="form-control"  value="<?php echo set_value('email',$customers['email']); ?>" />
                                            ...
                                            <!--        <input id="contact_person_name" name="contact_person_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('contact_person_name',$customers['contact_person_name']); ?>" />-->
                                            ...
                                            <!--        <input id="contact_person_phone" name="contact_person_phone" placeholder="" type="text" class="form-control"  value="<?php echo set_value('contact_person_phone',$customers['contact_person_phone']); ?>" />-->
                                            ...
                                            <!-- <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="text" name="cnic" placeholder="" type="text" class="form-control"  value="<?php echo set_value('cnic',$customers['cnic']); ?>" />
                                            ...
                                            <!--        <input id="postal_code" name="postal_code" placeholder="" type="text" class="form-control"  value="<?php echo set_value('postal_code',$customers['postal_code']); ?>" />-->
                                        ...
                                        <div class="row">
                                            ...
                                            <!--        <input id="contact_person_email" name="contact_person_email" placeholder="" type="email" class="form-control"  value="<?php echo set_value('contact_person_email',$customers['contact_person_email']); ?>" />-->
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="address" class="form-control"><?php echo set_value('address',$customers['address']); ?></textarea></div>
                                        ...
                                        <div class="row">
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="permanent_address" class="form-control"><?php echo set_value('permanent_address',$customers['permanent_address']); ?></textarea></div>
                                                    <span class="text-danger"></span>
                                                </div>
                                            </div> -->
                                        </div>
                                        <div class="row">    
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="note" class="form-control"><?php echo set_value('note',$customers['description']); ?></textarea></div>
                                                    <span class="text-danger"></span>
                                                </div>
                                            </div>      
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="ntn_no" name="ntn_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('ntn_no',$customers['ntn_no']); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="gstn" name="gstn" placeholder="" type="text" class="form-control"  value="<?php echo set_value('gstn',$customers['gstn']); ?>" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8" id="radioBtnDiv">
                                                        <label class="radio-inline">
                                                            <input type="radio" class="is_tax_status" name="is_tax_status" value="0" <?php if ($customers['is_tax_status'] == 0) { echo "checked"; } ?> ><?php echo $this->lang->line('disabled'); ?>
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" class="is_tax_status" name="is_tax_status" value="1" <?php if ($customers['is_tax_status'] == 1) { echo "checked"; } ?> ><?php echo $this->lang->line('enabled'); ?>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 hide" id="is_tax_status_percentage">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tax_percentage" id="tax_percentage" class="form-control" value="<?php echo set_value('tax_percentage',$customers['tax_percentage']); ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                                    <span class="text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="credit_limit" name="credit_limit" placeholder="" type="text" class="form-control"  value="<?php echo set_value('credit_limit',$customers['credit_limit']); ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/>
...
<script type="text/javascript">
    ...
    window.onload = function(){  
        var is_tax_status = '<?php echo $customers['is_tax_status']; ?>';  
        if(is_tax_status == '1'){
            $('#is_tax_status_percentage').removeClass('hide'); 
