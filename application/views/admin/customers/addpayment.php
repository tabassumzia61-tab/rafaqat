...
<div class="col-md-12">
    <div class="row">
    	<div class="box box-primary">
            <div class="box-body">
                <div class="col-md-6">
                    <input id="received" type="hidden" name="paid_types" value="received" />
                    <div class="form-group">
                        ...
                        <select autofocus="" id="voucher_type_id" name="voucher_type_id" class="form-control" >
                            ...
                            <option value="1" <?php if(set_value('voucher_type_id',1) == 1) echo "selected=selected" ?>><?php echo $this->lang->line('cr'); ?></option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control descriptions" id="descriptions" name="description" placeholder="" rows="3" placeholder="Enter ...">Cash Received</textarea>
                    <span class="text-danger"></span>
                </div>
                <!--<div class="form-group">-->
...
<script type="text/javascript">
    var voucher_type_id =   '<?php echo set_value('voucher_type_id',1) ?>';
    var account_mode_id = '<?php echo set_value('account_mode_id',12) ?>';
    ...
    $(document).on('change', '#voucher_type_id', function (e) {
        ...
        getaccountmodebyvoucher(voucher_type_id,0);
    });
    ...
    $(document).on('click', '.submit_fees', function (e) {
        ...
        if(amount == ''){
            ...
            if (radioValue == 'received') {    
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/customers/addcashByCustomersID") ?>',
                    type: 'post',
                    data: {'paid_types':radioValue,'paid_id':paid_id_re,'paid_amount':amount,'itemcustomersID':itemcustomersID,'payment_mode':payment_mode,'payment_type':payment_type,'description':description,'date':dateforfee},
