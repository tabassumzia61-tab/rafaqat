...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('quotations', 'can_edit')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_quotations'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/quotations/quotationsUpdateSave/'.$quotations['id']) ?>"  id="quotationssave" class="fromquotationssave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="around10">
                                                <div class="row">
                                                    <?php  
                                                    if ($this->rbac->hasPrivilege('quotations', 'can_branch')) { ?>
                                                        <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" id="quotes_date"  type="text" value="<?php if(!empty($quotations['date']) && $quotations['date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($quotations['date'])); } ?>" class="form-control quotes_date"/>
                                                            <span class="text-danger"><?php echo form_error('date'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label><?php echo $this->lang->line('quotations_no'); ?></label>
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="quotes_no" id="quotes_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $quotations['quotes_no']; ?>" readonly="readonly"/>
                                                            <span class="text-danger"><?php echo form_error('quotes_no'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label> <th><?php echo $this->lang->line('expiry').' '.$this->lang->line('date'); ?></th></label>
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="expiry_date" id="expiry_date"  type="text" value="<?php if(!empty($quotations['expiry_date']) && $quotations['expiry_date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($quotations['expiry_date'])); } ?>" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="customer_type" name="customer_type" class="form-control customer_type js-example-basic-single"  >
                                                                ...
                                                                foreach ($ct as $key => $val) { ?>
                                                                    <option value="<?php echo $key ?>" <?php if (set_value('customer_type',$quotations['customer_type']) == $key) echo "selected=selected" ?>><?php echo $val ?></option>
                                                                    <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="customer_id" name="customer_id" class="form-control customer_id js-example-basic-single"  >
                                                                ...
                                                                foreach ($customerslist as $val) {
                                                                    if($val['id'] == 1){}else{ ?>
                                                                        <option value="<?php echo $val['id'] ?>" <?php if (set_value('customer_id',$quotations['customer_id']) == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                            ...
                                                            <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                                                <thead>
                                                                    <tr class="font13 white-space-nowrap">
                                                                        <!-- <th width="5%">#</th> -->
                                                                        <th width="12%"><?php echo $this->lang->line('products_services'); ?><small class="req" style="color:red;"> *</small></th>
                                                                        <th width="12%"><?php echo $this->lang->line('description'); ?><small class="req" style="color:red;"> *</small></th>
                                                                        <th class="text-right" width="12%"><?php echo $this->lang->line('quantity'); ?><small class="req" style="color:red;"> *</small> <?php echo " | " . $this->lang->line('available_qty'); ?></th>
                                                                        <th class="text-right" width="10%"><?php echo $this->lang->line('unit') ?><small class="req" style="color:red;"> *</small></th>
                                                                        <th class="text-right" width="10%"><?php echo $this->lang->line('rate') . ' (' . $currency_symbol . ')'; ?><small class="req" style="color:red;"> *</small></th>
                                                                        <th class="" width="10%"><?php echo $this->lang->line('sale_tax_rate'); ?></th>
                                                                        <th class="" width="10%"><?php echo $this->lang->line('sale_tax'); ?></th>
                                                                        <th class="" width="10%"><?php echo $this->lang->line('discount_percent'); ?></th>
                                                                        <th class="" width="10%"><?php echo $this->lang->line('discount'); ?></th>
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $orderitem = $this->quotations_model->getItemsByQuotesID($quotations['id']); 
                                                                    $rnum = 1;
                                                                    if(!empty($orderitem)){ 
                                                                        foreach ($orderitem as $oikey => $oival) { ?> 
                                                                            ...
                                                                            <tr id="row<?php echo $rnum; ?>">
                                                                                ...
                                                                                <td class="text-right">
                                                                                    <div class=""> 
                                                                                            <div class="input-group">
                                                                                            <input type="text" class="form-control text-right right-border-none rate_tax"  name="rate_tax_<?php echo $rnum; ?>"  id="rate_tax<?php echo $rnum; ?>"  autocomplete="off" value="<?php echo $oival['item_tax']; ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                                                                ...
                                                                                <td class="text-right">
                                                                                    <div class=""> 
                                                                                            <div class="input-group">
                                                                                            <input type="text" class="form-control text-right right-border-none tax"  name="tax_<?php echo $rnum; ?>"  id="tax<?php echo $rnum; ?>"  readonly autocomplete="off" style="background-color:#eee3e3;" value="<?php echo number_format($oival['tax'],2,'.',','); ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                                                                            </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td class="text-right">
                                                                                    <div class=""> 
                                                                                            <div class="input-group">
                                                                                            <input type="text" class="form-control text-right right-border-none discount_per"  name="discount_per_<?php echo $rnum; ?>"  id="discount_per<?php echo $rnum; ?>"  autocomplete="off" value="<?php echo $oival['item_discount']; ?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                                                                            <span class="input-group-addon "> %</span>
                                                                                            </div>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td class="text-right w-100px">
                                                                                    <input type="text" name="amount_<?php echo $rnum; ?>" id="amount<?php echo $rnum; ?>" placeholder="" class="form-control text-right subtot" style="background-color:#eee3e3;" value="<?php echo number_format($oival['subtotal'],2,'.',','); ?>" readonly onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                                                                </td>
                                                                                <td>
                                                            ...
                                                            <table class="carttable">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <input type="text" placeholder="Total" value="<?php echo number_format($quotations['total'],2,'.',','); ?>" name="total" id="total" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control total"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($quotations['total_discount'],2,'.',','); ?>" name="discount" id="discount" readonly style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control discount"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" name="total_tax" readonly value="<?php echo number_format($quotations['total_tax'],2,'.',','); ?>" id="total_tax" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control total_tax"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
                                                                        <td colspan="2"  class="text-right">
                                                                            <input type="text" placeholder="" value="<?php echo number_format($quotations['grand_total'],2,'.',','); ?>" name="net_amount" id="net_amount" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control net_amount"/></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table> 
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="customer_message" name="customer_message" placeholder=""  class="form-control" style="height: 100px"><?php echo set_value('customer_message',$quotations['note']) ?></textarea>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="quotationssave" class="btn btn-info quotationssave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    var selcustomer_type = '<?php echo $quotations['customer_type']; ?>';
    ...
    function getItemDetail(item_obj,item_id,item_details){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/quotations/addtocart") ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var customer_id =   '<?php echo set_value('customer_id',$quotations['customer_id']) ?>';
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#quotationssave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/quotations/quotationsUpdatePrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.quotationssave', function (e) {
            var itemsel = $('.itemsel').val();
            if(itemsel == ''){
                errorMsg('Please Select Order Items Before!');
            }else{
                var $id = '<?php echo $quotations['id']; ?>';
                var $this = $(this);
                $this.button('loading');
                $('.quotationssave').prop("disabled", true);
                var formData = new FormData($('#quotationssave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/quotations/quotationsUpdateSave/") ?>'+$id,
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
                    ...
                    success: function (data, status, xhr) {
                        if (data.status == "fail") {
                            $('.quotationssave').prop("disabled", false);
                            $this.button('reset');
                            var message = "";
