...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('quotations', 'can_add')) { ?>
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_quotations'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/quotations/quotationsSave') ?>"  id="quotationssave" class="fromquotationssave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" id="quotes_date"  type="text" value="" class="form-control quotes_date"/>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="quotes_no" id="quotes_no" type="text" class="form-control" style="background-color:#eee3e3;" value="<?php echo $quotes_no; ?>" readonly="readonly"/>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="req" style="color:red;"> *</small> 
                                                            <input name="expiry_date" id="expiry_date"  type="text" value="" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  id="customer_id" name="customer_id" class="form-control customer_id js-example-basic-single"  >
                                                                ...
                                                                foreach ($customerslist as $val) {
                                                                    if($val['id'] == 1){}else{ ?>
                                                                        <option value="<?php echo $val['id'] ?>" <?php if (set_value('customer_id') == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                            ...
                                                            <table class="carttable">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" value="0" name="discount" id="discount" readonly style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control discount"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <input type="text" placeholder="" name="total_tax" readonly value="0" id="total_tax" style="width: 50%; float: right;background-color:#eee3e3 !important;" class="form-control total_tax"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="quotationssave" class="btn btn-info quotationssave"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_new'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click','.printsavebtn', function (e) {
            ...
            if(itemsel == ''){
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/quotations/quotationsPrintSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
        ...
        $(document).on('click','.quotationssave', function (e) {
            ...
            if(itemsel == ''){
                ...
                var formData = new FormData($('#quotationssave')[0]);
                $.ajax({
                    url: '<?php echo site_url("admin/quotations/quotationsSave") ?>',
                    type: 'POST',
                    async: false,
                    data: formData,
                    contentType: false,
