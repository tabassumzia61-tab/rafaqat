            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('quotations_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('quotations', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/quotations/create/<?php echo $brc_id; ?>" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_quotations'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/quotations/searchquotations') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:20px 0 0 0px">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                <div class="download_label"><?php echo $this->lang->line('quotations_list'); ?></div>
                                <table class="table table-striped table-bordered table-hover quotations-list">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('sr'); ?></th>
                                            <th><?php echo $this->lang->line('date'); ?></th>
                                            <th><?php echo $this->lang->line('quotations_no'); ?></th>
...
<div class="quotationsModal modal fade" id="quotationsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title modal-titles" id="myModalLabel"><?php echo $this->lang->line('quotations'); ?> </h4>
            </div>
            <div class="modal-body modal-quotations-body" style="padding: 8px;width: 100%;display: inline-block;">
            </div>
        </div>
    </div>
</div>
<script>
    ...
    $(document).ready(function () {
        initDatatable('quotations-list','admin/quotations/getquotationslist/'+brc_id, [],[], 100,
            [
...
<script type="text/javascript">
    $(document).ready(function (e) {
        ...
        $('#quotationsModal').on('show.bs.modal', function (e) {
            var quot_id = $(e.relatedTarget).data('quot_id');
            var $modalDiv = $(event.delegateTarget);
            var baseUrl = '<?php echo base_url() ?>';
            $('.modal-quotations-body').html("");
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/quotations/viewquotationsinvoice') ?>",
                dataType: 'text',
                ...
                success: function (response) {
                    ...
                    $('.modal-quotations-body').html(response);
                },
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('quotations-list','admin/quotations/getsearchquotationslist',response.params);
                        }
                      },
...
<script type="text/javascript">
    function getBranchByID(val){
        //alert();
        var url ='<?php echo site_url('admin/quotations/index/'); ?>'+val;          
        if(url){
