        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><?php echo $this->lang->line('change_password'); ?></h4>
              
              <?php //echo site_url('admin/admin/changepass') ?>
              <form method="post" action="<?php echo site_url('user/reset-password.html').'?v_code='.$verification_code ?>" class="mb-3" >
                <?php 
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="current_password"><?php echo $this->lang->line('current_password'); ?></label>
                  </div>
                  <div class="input-group input-group-merge">
                    <input
                      ...
                      placeholder="<?php echo $this->lang->line('current_password'); ?>"
                      class="form-control"
                      id="current_password"
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="new_password"><?php echo $this->lang->line('new_password'); ?></label>
                  </div>
                  <div class="input-group input-group-merge">
                    <input
                      type="password"
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="confirm_password"><?php echo $this->lang->line('confirm_password'); ?></label>
                  </div>
                  <div class="input-group input-group-merge">
                    <input
                      type="password"
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit"><?php echo $this->lang->line('change_password'); ?> &nbsp;</button>
                </div>
              </form>
            </div>
          </div>
