            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('expense_bill_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('expenses', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/expenses/create/<?php echo $brc_id; ?>" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_expense_bill'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/expenses/searchexpenses') ?>" method="post" id="searchform" class="searchform">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select name="accounts_id" class="form-control js-example-basic-single">
                                            <option value=""><?php echo $this->lang->line("select"); ?></option>
                                            <?php foreach ($accheadlist as $acckey => $accval) {  ?>
                                                <option <?php
                        ...
                        <div class="col-md-12" style="padding:20px 0 0 0px">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                ...
                                <table class="table table-striped table-bordered table-hover expenses-list">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('expenses-list','admin/expenses/getexpenseslist/'+brc_id, [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('expenses-list','admin/expenses/getsearchexpenseslist',response.params);
                        }
                      },
