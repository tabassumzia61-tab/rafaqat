...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
            <?php if (($this->rbac->hasPrivilege('expenses', 'can_add'))) {
                ?>     
                <div class="col-md-12">           
                    <div class="box box-primary">
                        ...
                        <form id="accvoucherform" action="<?php echo base_url() ?>admin/expenses/expensesUpdateSave" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                <input type="hidden" name="expid" value="<?php echo $expense['id']; ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="expense_date" name="expense_date" placeholder="" type="text" class="form-control date"  value="<?php if(!empty($expense['date']) && $expense['date'] !='0000-00-00'){ echo date($this->customlib->getSystemDateFormat(), $this->customlib->dateyyyymmddTodateformat($expense['date'])); } ?>" readonly="readonly" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  id="bill_type" name="bill_type" class="form-control bill_type js-example-basic-single"  >
                                                    ...
                                                    foreach ($ct as $key => $val) { ?>
                                                        <option value="<?php echo $key ?>" <?php if (set_value('bill_type',$expense['bill_type']) == $key) echo "selected=selected" ?>><?php echo $val ?></option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="payment_mode" name="payment_mode" class="form-control payment_mode">
                                                    ...
                                                    <?php foreach ($acclist as $acc_val) { ?>
                                                        <option value="<?php echo $acc_val['id'] ?>" <?php if (set_value('payment_mode',$expense['par_acc_head_id']) == $acc_val['id']) echo "selected=selected"; ?>><?php echo $acc_val['name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  id="supplier_id" name="supplier_id" class="form-control supplier_id js-example-basic-single"  >
                                                    ...
                                                    foreach ($supplierlist as $val) {
                                                        if($val['id'] == 1) { }else{ ?>
                                                            <option value="<?php echo $val['id'] ?>" <?php if (set_value('supplier_id',$expense['supplier_id']) == $val['id']) echo "selected=selected" ?>><?php echo $val['code'].' - '.$val['name'] ?></option>
                                                        <?php
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        <div class="tshadow mb25 bozero" style="margin-bottom: 15px;">
                                            ...
                                            <div class="row around10">
                                                <?php 
                                                    $expgtam = 0;
                                                    $expenseitem = $this->expenses_model->getItemsByExpID($expense['id']); 
                                                    if(!empty($expenseitem)){
                                                        foreach($expenseitem as $expikey => $expival){ 
                                                            $expgtam = $expgtam + (float)$expival['debit_amount']; 
                                                            ?>
                                                            <input type="hidden" name="previous_id[]" value="<?php echo $expival['id']; ?>">
                                                            <div class="col-md-12 remove_field_warp" style="padding:10px 0 0 0;">
                                                                <input type="hidden" name="update_id_<?php echo $expikey; ?>" value="<?php echo $expival['id']; ?>">
                                                                <input type="hidden" name="carts_id[]" value="<?php echo $expival['id']; ?>">
                                                                <div style="margin-top:5px;" class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select id="account_head" name="account_head[]" class="form-control account_head">
                                                                                ...
                                                                                <?php foreach ($accheadlist as $acch_val) { ?>
                                                                                    <option value="<?php echo $acch_val['id'] ?>" <?php if ($expival['acc_head_id'] == $acch_val['id']){ echo "selected=selected"; } ?> ><?php echo $acch_val['name']; ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-3" style="padding:0 10px 0 0;">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="debit_amount" name="debit_amount[]" class="form-control debit_amount" onkeyup="getdebittotal(this)" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" value="<?php echo (float)$expival['debit_amount']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div style="margin-top:20px;text-align:center;padding:0px;" class="col-md-1">
                                                                        <button type="button" class="btn btn-sm btn-danger remove_field" ><i class="fa fa-trash"></i></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                ...
                                                <div class="col-md-12 remove_field_warp" style="padding:10px 0 0 0;">
                                                    ...
                                                    <div class="amounttotalwrap">
                                                        <div style="margin-top:5px;" class="col-md-12">
                                                            ...
                                                            <div class="col-md-3 total_debit_amount" style="padding-left:30px;font-weight:bold;"><?php echo $expgtam; ?></div>
                                                            <input type="hidden" name="grand_total" class="grand_total_debit_amount" value="<?php echo $expgtam; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('description',$expense['note']); ?></textarea>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="" id="savenew" class="btn btn-info savenew"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>  
                                </div>
                            </div>
                        </form>
                    </div>   
...
<script type="text/javascript">
    var selbil_type = '<?php echo $expense['bill_type']; ?>';
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on('click','.savenew', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url("admin/expenses/expensesUpdateSave") ?>',
                type: 'POST',
                async: false,
                data: formData,
                contentType: false,
