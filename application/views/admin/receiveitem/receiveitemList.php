            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('receiveitem_list'); ?></h3>
                        <?php if ($this->rbac->hasPrivilege('receiveitem', 'can_add')) {?>
                            <small class="pull-right">
                                <a href="<?php echo base_url(); ?>admin/receiveitem/create" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_receiveitem'); ?>
                                </a>
                            </small>
                        <?php }?>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <form role="form" action="<?php echo site_url('admin/receiveitem/searchreceiveitem') ?>" method="post" id="searchform" class="searchform">
                        ...
                        <div class="col-md-12" style="padding:15px 0 0 0">
                            <div class="mailbox-messages table-responsive overflow-visible">
                                <div class="download_label"><?php echo $this->lang->line('receiveitem_list'); ?></div>
                                <table class="table table-striped table-bordered table-hover receiveitem-list">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function () {
        initDatatable('receiveitem-list','admin/receiveitem/getreceiveitemlist', [],[], 100,
            [
                   ...
                   data: form_data, // serializes the form's elements.
                      ...
                      success: function(response) { // your success handler
                        ...
                        if(!response.status){
                            ...
                            initDatatable('receiveitem-list','admin/receiveitem/getsearchreceiveitemlist',response.params);
                        }
                      },
...
<script type="text/javascript">
    function viewDetail(id) {
        $.ajax({
            url: '<?php echo base_url() ?>admin/receiveitem/getBillDetails/' + id,
            type: "GET",
            data: {id: id},
