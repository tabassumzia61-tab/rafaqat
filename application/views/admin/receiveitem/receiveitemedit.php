        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="purchase_edit_sale_from" action="<?php echo site_url('admin/receiveitem/save_edit_receiveitem/').$result["id"]; ?>" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">

                            <div class="tshadow mb25 bozero">    

                                <h4 class="pagetitleh2"><?php echo $this->lang->line('edit_receiveitem'); ?> </h4>
                                ...
                                <div class="around10">
                                    ...
                                    <input type="hidden" id="receiveitem_bill_id" name="receiveitem_bill_id" value="<?php echo set_value('receiveitem_bill_id',$result['id']); ?>" />
                                    <?php 
                                        $getproductdetail = $this->receiveitem_model->getbilldetilproductbyid($result["id"]); 
    ...
    $(document).ready(function () {
        $(document).on('click', '.purchase_edit_sale_add', function (e) {
            ...
            if(itemsel == ''){
                ...
                var $this = $(this);
                var $id = $('#receiveitem_bill_id').val();
                var formData = new FormData($('#purchase_edit_sale_from')[0]);
                $this.button('loading');
                setTimeout(function () {
                    $.ajax({
                        url: '<?php echo site_url("admin/receiveitem/save_edit_receiveitem/") ?>'+$id,
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
