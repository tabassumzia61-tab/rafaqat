                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadding">
                            <div class="loginbg">
                                ...
                                <div class="form-bottom">
                                    ...
                                    ?>
                                    <form action="<?php echo site_url('staff/forgotpassword') ?>" method="post">
                                    ...
                                    <a href="<?php echo site_url('staff/login') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('staff_login'); ?></a>
                                </div>
                            </div>
                        </div>  
                    </div>  
